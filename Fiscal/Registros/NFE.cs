...
namespace Fiscal
{
    public class NFE
    {
        ...
        [DisplayName("Código de Operação")]
        ...
        [DisplayName("Valor do ICMS para a UF de Destino")]
        public decimal ValorICMSUFDest { get; set; }

        [DisplayName("Valor do ICMS para a UF do Remetente")]
        public decimal ValorICMSUFRemet { get; set; }

        [DisplayName("Outras Despesas")]
        public decimal OutrasDespesas { get; set; }

        [DisplayName("Total de Custo do Produto")]
        public decimal TotalCustoProduto { get; set; }

        [DisplayName("Total de Produtos")]
        public decimal TotalProdutos { get; set; }

        [DisplayName("Total de Serviço")]
        ...
        [DisplayName("Código da Condicional")]
        public string CodCondicional { get; set; }
        ...
        public bool JaFaturada { get; set; }

        [DisplayName("Sequência CCE")]
        public string SequenciaCCE { get; set; }

        [DisplayName("Código do Status de Cancelamento")]
        ...
        [DisplayName("Valor Total FCP ST")]
    ...
    public class NFEEntityTypeConfiguration : IEntityTypeConfiguration<NFE>
    {
        public void Configure(EntityTypeBuilder<NFE> builder)
        {
            ...
            builder.Property(e => e.HoraSaidaEntrada).HasColumnName("HORAENTRADASAIDA");
            ...
            builder.Property(e => e.ANTTTransportadora).HasColumnName("ANTTTRANSPORTADORA");
