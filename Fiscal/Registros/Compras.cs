...
namespace Fiscal
{
    public class Compras
    {
        ...
        public decimal? QtdeVolume { get; set; }
    ...
    public class ComprasEntityTypeConfiguration : IEntityTypeConfiguration<Compras>
    {
...

        {
            ...
            builder.Property(e => e.TotalCOFINSSub).HasColumnName("TOTALPISSUB");
            ...
            builder.Property(e => e.TotalBCIPI).HasColumnName("TOTALBCIPPI");
